...
// True for entries that are SVG markup (render via innerHTML); false for the plain-letter
// entries like Request's 'R' (render via textContent).
export const isScopeIconSvg = (value) => typeof value === 'string' && value.trim().startsWith('<svg');
